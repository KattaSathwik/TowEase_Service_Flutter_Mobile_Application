...
class All_User_Acc_Req_Details_Page extends StatefulWidget {
  final String id;

  All_User_Acc_Req_Details_Page({super.key, required this.id});

  //const Farmer({super.key, required String id});

  @override
  // ignore: no_logic_in_create_state
  State<All_User_Acc_Req_Details_Page> createState() =>
      All_User_Acc_Req_Details_Page_State(id: id);
}

class All_User_Acc_Req_Details_Page_State extends State<All_User_Acc_Req_Details_Page> {
  String? id;
  var role;
  var email;
  var name;
  ...
  All_User_Acc_Req_Details_Page_State({required this.id});
  ...
  postDetailsToFirestore() async {
    ...
    if (acceptedUserDetailsList == Null || acceptedUserDetailsList.isEmpty) {
      QuickAlert.show(
        ...
        title: "Warning",
        text:
        "There are no accepted requests till now",
