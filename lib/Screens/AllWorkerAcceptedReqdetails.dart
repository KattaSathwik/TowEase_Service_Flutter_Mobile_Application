...
class All_Worker_Acc_Req_Details_Page extends StatefulWidget {
  final String id;

  All_Worker_Acc_Req_Details_Page({super.key, required this.id});

  //const Farmer({super.key, required String id});

  @override
  // ignore: no_logic_in_create_state
  State<All_Worker_Acc_Req_Details_Page> createState() =>
      All_Worker_Acc_Req_Details_Page_State(id: id);
}

class All_Worker_Acc_Req_Details_Page_State extends State<All_Worker_Acc_Req_Details_Page> {
  String? id;
  var role;
  var email;
  var name;
  ...
  All_Worker_Acc_Req_Details_Page_State({required this.id});
          ...
          child: SingleChildScrollView(
            child: Stack(
              children: [
                ...
                PageTitleBar(
                    title:
                    'Welcome $name\nHere you will see all accepted request details!'),
                Padding(
                    ...
                    child: Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          //iconButton(context),
                          const Text(
                            "In order to see all accepted the request details",
                            style: TextStyle(
                                color: Colors.white,
                          ...
                          Form(
                            ...
                            child: Column(
                              children: [
                                RoundedButton(
                                    text: 'Get all accepted request details',
                                    press: () async {
  ...
  postDetailsToFirestore() async {
    ...
    for (var userDetails in acceptedUserDetailsList) {
      ...
      QuickAlert.show(
        ...
        title: "Booking ${i++}",
        text:
        "Accepted_Booking Id : $accepteduserdetailsId\nservicername : $servicername\nusername : $username\nusernameid : $usernameid\nservicernameid : $servicernameid\nCurrent userlocation : $userlocation\nBookingStatus : $bookingStatus\nName : $name\ntosendReq : $sendReq\nvechicleType : $vecType",
        ...
        onCancelBtnTap: () async {
          ...
          userSendDetailsAccDriWork.location = userlocation;
          ...
          QuickAlert.show(
              context: context,
              title: "Success",
              text: "Rejected accepeted request was added to \nuserSendDetailsAccDriWork document Successfully :)",
              type: QuickAlertType.success,
              confirmBtnText: "Done");
          Fluttertoast.showToast(msg: "Rejected accepeted request was added to \nuserSendDetailsAccDriWork document Successfully :)");
        },
