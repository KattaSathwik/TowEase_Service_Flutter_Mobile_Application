...
class All_Worker_Req_Details_Page extends StatefulWidget {
  final String id;

  All_Worker_Req_Details_Page({super.key, required this.id});

  //const Farmer({super.key, required String id});

  @override
  // ignore: no_logic_in_create_state
  State<All_Worker_Req_Details_Page> createState() =>
      All_Worker_Req_Details_Page_State(id: id);
}

class All_Worker_Req_Details_Page_State extends State<All_Worker_Req_Details_Page> {
  String? id;
  var role;
  var email;
  var name;
  ...
  All_Worker_Req_Details_Page_State({required this.id});
