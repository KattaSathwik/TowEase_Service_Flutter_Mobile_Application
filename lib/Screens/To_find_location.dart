...
class User_Location_Page extends StatefulWidget {
  final String id;

  User_Location_Page({super.key, required this.id});

  //const Farmer({super.key, required String id});

  @override
  // ignore: no_logic_in_create_state
  State<User_Location_Page> createState() => User_Location_Page_State(id: id);
}

class User_Location_Page_State extends State<User_Location_Page> {
  String? id;
  var role;
  var email;
  var name;
  ...
  User_Location_Page_State({required this.id});
                              ...
                              children: [
                                RoundedButton(
                                    ...
                                    press: () async {
                                      ...
                                      postDetailsToFirestore(loc_name);
                                    }),
                                const SizedBox(
                                  height: 10,
                                ),
  ...
  postDetailsToFirestore(String location) async {
    ...
    userrole.location = location;

    await firebaseFirestore
        .collection("register_user")
        .doc(id)
        .set(userrole.locToMap());
    QuickAlert.show(
        context: context,
        title: "Success",
        text:
        ...
        confirmBtnText: "Done");
    Fluttertoast.showToast(msg: "location Added to database successfully :) ");
