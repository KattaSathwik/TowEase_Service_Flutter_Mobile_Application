...
class Worker_Home_Page extends StatefulWidget {
  ...
  Worker_Home_Page({super.key, required this.id});

  //const Farmer({super.key, required String id});

  @override
  // ignore: no_logic_in_create_state
  State<Worker_Home_Page> createState() => Worker_Home_Page_State(id: id);
}

class Worker_Home_Page_State extends State<Worker_Home_Page> {
  String? id;
  var role;
  var email;
  var name;
  ...
  Worker_Home_Page_State({required this.id});
                                ...
                                onTap: () {
                                  if (index == 0) {
                                    ...
                                    Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                        builder: (context) =>
                                            All_Worker_Req_Details_Page(id: widget.id),
                                      ),
                                    );
                                  } else {
                                    Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                        builder: (context) =>
                                            All_Worker_Acc_Req_Details_Page(id: widget.id),
                                      ),
                                    );
                                  }
                                },
